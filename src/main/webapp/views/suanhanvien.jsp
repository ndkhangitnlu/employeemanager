...
<form:form action="/employee/edit" method = "POST" modelAttribute="employee">
    <div>
        <form:label path="employeeId">* Mã NV ${employee.employeeId}</form:label>
    ...
    <div>
        ...
        <a href="/employee/list"><form:button >Hủy bỏ</form:button></a>
    </div>
</form:form>
</body>
</html>